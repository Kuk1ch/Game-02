...
{
    public partial class Битва_2 : Form
    {
        public Битва_2()
        {
            InitializeComponent();
        ...
        private void pictureBox11_Click(object sender, EventArgs e)
        {
            ...
            else if (p33 == 4 || p33 == 5 || p33 == 6)
            {
                ...
                if (hod == 0)
                {
                    ...
                    ya();
                    smertm();
                    label2.Text = "Здоровье " + monx + "/" + monm.ToString();
                    hod = 3;
                    label5.Text = hod + "/3";
                    z = 0;
                    label3.Text = "" + z;
            ...
            else if (p33 == 7 || p33 == 8 || p33 == 10)
            {
                ...
                hod--;
                label5.Text = hod + "/3";
                label1.Text = "Здоровье " + p.HP + "/" + p.HPM.ToString();
                pictureBox11.Image = Properties.Resources.Card_back_01_svg;
                pictureBox11.Enabled = false;
                if (hod == 0)
                {
        ...
        {
            Колода рол = new Колода();
            рол.Show();
        }

        private void Битва_2_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.L)
            {
                monx = 1;
        ...
        private void Битва_2_Load(object sender, EventArgs e)
        {
            timer1.Start();
            label1.Text = "Здоровье " + p.HP + "/" + p.HPM;

            label2.Text = "Здоровье " + monx + "/" + monm;
            en();
            p1();
            p2();
            p3();
        ...
        private void timer3_Tick(object sender, EventArgs e)
        {
            ...
            if (yd == 0)
            {
                pictureBox1.Image = Супер_игра_2.Properties.Resources.Удар;
                if (vre == 10)
                {
                    monx -= 6;
                    hod--;
                    ...
                    label5.Text = hod + "/3";
                    vre = 0;
                    pictureBox1.Image = Супер_игра_2.Properties.Resources.ss;
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            if (kon == 1)
            {
                pictureBox1.Image = Супер_игра_2.Properties.Resources.ss111;
                if (vre == 10)
                {
